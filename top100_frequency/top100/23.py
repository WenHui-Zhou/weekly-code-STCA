...
class Solution(object):
    def mergeKLists(self, lists):
        ...
        def heapify(nums,n,root):
            ...
            c2 = root*2 + 2
            min_index = root
            if c1 <= n and nums[c1].val < nums[min_index].val:
                min_index = c1
            if c2 <= n and nums[c2].val < nums[min_index].val:
                min_index = c2
            if min_index != root:
                nums[root],nums[min_index] = nums[min_index],nums[root]
                heapify(nums,n,min_index)
        def create_heap(nums):
            n = len(nums) - 1
            last_index = (n - 1) // 2
        ...
        def heapify(nums,n,i):
            ...
            c2 = i*2 + 2
            min_index = i
            if c1 <= n and nums[c1].val < nums[i].val:
                min_index = c1
            if c2 <= n and nums[c2].val < nums[min_index].val:
                min_index = c2
            if min_index != i:
